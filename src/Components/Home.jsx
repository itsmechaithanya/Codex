  ...
  return (
    <div className='bg-black text-white w-full overflow-hidden h-fit'>
      ...
      <div className='w-full h-screen relative'>
        <div className='absolute z-10 lg:bottom-[10vh] bottom-[20vh] left-[5vw] lg:text-[8vw] text-[7vh] lg:leading-[6.5vw] leading-[7.5vh] font-extrabold'>Code. <br /> Create. <br /> Collaborate.</div>
